...
class CronJob extends \infuse\Model
{
	...
	public static $properties = array(
		...
		'minute' => array(
			'type' => 'text',
			'length' => 2,
			'validate' => array( '\\app\\cron\\models\\CronJob', 'validateMinute' )
		),
		'hour' => array(
			'type' => 'text',
			'length' => 2,
			'validate' => array( '\\app\\cron\\models\\CronJob', 'validateHour' )
		),
		'day' => array(
			'type' => 'text',
			'length' => 2,
			'validate' => array( '\\app\\cron\\models\\CronJob', 'validateDay' )
		),
		'month' => array(
			'type' => 'text',
			'length' => 2,
			'validate' => array( '\\app\\cron\\models\\CronJob', 'validateMonth' )
		),
		'week' => array(
			'type' => 'text',
			'length' => 2,
			'validate' => array( '\\app\\cron\\models\\CronJob', 'validateWeek' )
		),
		'next_run' => array(
			'type' => 'date'
		),
